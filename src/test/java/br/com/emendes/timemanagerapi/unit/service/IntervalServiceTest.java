...
class IntervalServiceTest {
  ...
  class FindMethod {
    ...
    @Test
    @DisplayName("find must returns Page<IntervalResponseBody> when ActivityId exist")
    void find_MustReturnsPageIntervalResponseBody_WhenActivityIdExist(){
    ...
    @Test
    @DisplayName("find must returns empty Page<IntervalResponseBody> when Activity hasn't Intervals")
    void find_MustReturnsEmptyPageIntervalResponseBody_WhenActivityHasntIntervals(){
      BDDMockito.when(intervalRepositoryMock.findByActivity(DEFAULT_ACTIVITY, DEFAULT_PAGEABLE))
