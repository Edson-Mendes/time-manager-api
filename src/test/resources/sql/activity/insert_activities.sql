...
INSERT INTO tb_activity (name, description, created_at, status, user_id) VALUES
    ...
    ('Awesome activity 2', 'Some awesome activity 2', '2022-10-23 09:00:00', 'ACTIVE', 1000),
    ('Another awesome activity 1', 'Another some awesome activity 1', '2022-10-24 10:00:00', 'ACTIVE', 1000),
    ('Another awesome activity 2', 'Another some awesome activity 2', '2022-10-24 11:00:00', 'ACTIVE', 1000);